...
public class EmployeesDatabase {
	...
	public static void AddEmployee(Employee e, Database database) throws SQLException {
		String insert ="INSERT INTO `employees`(`ID`, `Name`, `Email`, `Tel`, `Salary`, `Position`) VALUES "
				+ "('"+e.getID()+"','"+e.getName()+"', '"+e.getEmail()+"', '"+e.getTel()+"' , '"+e.getSalary()+"' , '"+e.getPosition()+"');";
	...
	public static  ArrayList<Employee>getAllEmployees(Database database) throws SQLException{
	 ...
	 public static void EditEmployee(Employee e ,Database database) throws SQLException {
		String update=" UPDATE `employees` SET `Name`='"+e.getName()+"',`Email`='"+e.getEmail()+"',`Tel`='"+e.getTel()+"'  ,`Salary`='"+e.getSalary()+"',`Position`='"+e.getPosition()+"'"
				+ " WHERE 'ID' ='"+e.getID()+"'     ;";
