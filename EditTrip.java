...
public class EditTrip {
	...
	private JTextField start, destination , price;
	 ...
	 public EditTrip (JFrame parent ,Database database) throws SQLException {
			...
			String[] yyyy = new String[300];
			yyyy[0] = "yyyy";
			for (int i=2010; i<2060; i++) {
				yyyy[i-2009]= String.format("%04d", i);
			}
		        ...
		        submit.addActionListener(new ActionListener() {
		            ...
		            public void actionPerformed(ActionEvent e) {
		                ...
		                try {
		                    ...
		                    trip.setDate(d);  // Assuming that this date format is expected by the Trip object.
		                } catch (Exception ex) {
					...
					public void actionPerformed(ActionEvent e) {
						try {
							TripsDatabase.DeleteTrip(id.getSelectedItem().toString(), database);
							  JOptionPane.showMessageDialog(frame, "Trip Delete Successfully");
							  Main.refreshTable(TripsDatabase.getAllTrips(database));
				                 frame.dispose();
						} catch(SQLException e1) {
	 ...
	 public void refreshData(Database database) throws SQLException {
